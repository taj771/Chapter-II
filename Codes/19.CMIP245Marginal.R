...
####### CMIP245 ####### CMIP245 ####### CMIP245 ####### CMIP245 ####### CMIP245

# wheat
# Set the directory path where the CSV files are located
file_path <- "./AquaCropOPSyData/ClimateData/CMIP6/CMIP245/WheatCMIP245"


# Get a list of all files that match the pattern
file_list <- list.files(path = file_path, pattern = "^merged_simulation_results_wheat_marginal_CMIP245_\\d{4}\\.csv$", full.names = TRUE)
...
df_wheat_CMIP245 <- wheat_marginal%>%
  left_join(df_wheat_rf, by = c("year", "Site"))

df_wheat_CMIP245 <- df_wheat_CMIP245%>%
...
wheat2030 <- df_wheat_CMIP245%>%
  filter(year==2030)
wheat2040 <- df_wheat_CMIP245%>%
  filter(year==2040)
wheat2050 <- df_wheat_CMIP245%>%
  filter(year==2050)
wheat2060 <- df_wheat_CMIP245%>%
  filter(year==2060)
wheat2080 <- df_wheat_CMIP245%>%
  filter(year==2080)
wheat2100 <- df_wheat_CMIP245%>%
  filter(year==2100)
...
df_wheat_CMIP245 <- rbind(wheat2030, wheat2040, wheat2050, wheat2060, wheat2080, wheat2100)



# canola # canola # canola # canola # canola # canola # canola # canola # canola
# Set the directory path where the CSV files are located
file_path <- "./AquaCropOPSyData/ClimateData/CMIP6/CMIP245/CanolaCMIP245"


# Get a list of all files that match the pattern
file_list <- list.files(path = file_path, pattern = "^merged_simulation_results_canola_marginal_CMIP245_\\d{4}\\.csv$", full.names = TRUE)
...
df_canola_CMIP245 <- canola_marginal%>%
  left_join(df_canola_rf, by = c("year", "Site"))


df_canola_CMIP245 <- df_canola_CMIP245%>%
...
canola2030 <- df_canola_CMIP245%>%
  filter(year==2030)
canola2040 <- df_canola_CMIP245%>%
  filter(year==2040)
canola2050 <- df_canola_CMIP245%>%
  filter(year==2050)
canola2060 <- df_canola_CMIP245%>%
  filter(year==2060)
canola2080 <- df_canola_CMIP245%>%
  filter(year==2080)
canola2100 <- df_canola_CMIP245%>%
  filter(year==2100)
...
df_canola_CMIP245 <- rbind(canola2030, canola2040, canola2050, canola2060, canola2080, canola2100)
...
df_CMIP245 <- df_wheat_CMIP245%>%
  left_join(df_canola_CMIP245)%>%
...
df_CMIP245 <- rbind(df_CMIP245,df1)
...
df_CMIP245 <- df_CMIP245%>%
  filter(Irrigation_Level < 750)

ggplot(df_CMIP245, aes(x = as.factor(Irrigation_Level), y = val_mm, fill = as.factor(Year))) + 
  ...
  scale_y_continuous(name = expression("Marginal Value ($/m"^3*")"),
                     limits = c(0.1, 0.8), breaks = seq(0,1 , by = 0.05)) + # Customize y-axis scale
...
write.csv(df_CMIP245, "./AquaCropOPSyData/ClimateData/CMIP6/CMIP245/Marginal_CMIP245.csv")
