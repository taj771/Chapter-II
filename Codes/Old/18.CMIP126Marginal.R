...
####### CMIP126 ####### CMIP126 ####### CMIP126 ####### CMIP126 ####### CMIP126

# wheat
# Set the directory path where the CSV files are located
file_path <- "./AquaCropOPSyData/ClimateData/CMIP6/CMIP126/WheatCMIP126"


# Get a list of all files that match the pattern
file_list <- list.files(path = file_path, pattern = "^merged_simulation_results_wheat_marginal_CMIP126_\\d{4}\\.csv$", full.names = TRUE)
...
df_wheat_CMIP126 <- wheat_marginal%>%
  left_join(df_wheat_rf, by = c("year", "Site"))

df_wheat_CMIP126 <- df_wheat_CMIP126%>%
...
wheat2030 <- df_wheat_CMIP126%>%
  filter(year==2030)
wheat2040 <- df_wheat_CMIP126%>%
  filter(year==2040)
wheat2050 <- df_wheat_CMIP126%>%
  filter(year==2050)
wheat2060 <- df_wheat_CMIP126%>%
  filter(year==2060)
wheat2080 <- df_wheat_CMIP126%>%
  filter(year==2080)
wheat2100 <- df_wheat_CMIP126%>%
  filter(year==2100)
...
df_wheat_CMIP126 <- rbind(wheat2030, wheat2040, wheat2050, wheat2060, wheat2080, wheat2100)


# canola # canola # canola # canola # canola # canola # canola # canola # canola
# Set the directory path where the CSV files are located
file_path <- "./AquaCropOPSyData/ClimateData/CMIP6/CMIP126/CanolaCMIP126"


# Get a list of all files that match the pattern
file_list <- list.files(path = file_path, pattern = "^merged_simulation_results_canola_marginal_CMIP126_\\d{4}\\.csv$", full.names = TRUE)
...
df_canola_CMIP126 <- canola_marginal%>%
  left_join(df_canola_rf, by = c("year", "Site"))


df_canola_CMIP126 <- df_canola_CMIP126%>%
...
canola2030 <- df_canola_CMIP126%>%
  filter(year==2030)
canola2040 <- df_canola_CMIP126%>%
  filter(year==2040)
canola2050 <- df_canola_CMIP126%>%
  filter(year==2050)
canola2060 <- df_canola_CMIP126%>%
  filter(year==2060)
canola2080 <- df_canola_CMIP126%>%
  filter(year==2080)
canola2100 <- df_canola_CMIP126%>%
  filter(year==2100)
...
df_canola_CMIP126 <- rbind(canola2030, canola2040, canola2050, canola2060, canola2080, canola2100)
...
df_CMIP126 <- df_wheat_CMIP126%>%
  left_join(df_canola_CMIP126)%>%
...
df_CMIP126 <- rbind(df_CMIP126,df1)
...
df_CMIP126 <- df_CMIP126%>%
  filter(Irrigation_Level < 750)

ggplot(df_CMIP126, aes(x = as.factor(Irrigation_Level), y = val_mm, fill = as.factor(Year))) + 
...
write.csv(df_CMIP126, "./AquaCropOPSyData/ClimateData/CMIP6/CMIP126/Marginal_CMIP126.csv")
