...
def evaluate(smts, max_irr_season, wdf, test=False):
    ...
    """
    out = run_model(smts, max_irr_season, year1=2032, year2=2032, wdf=wdf)
...
merged_results.to_csv(
    '/Users/tharakajayalath/Library/CloudStorage/OneDrive-UniversityofSaskatchewan/Chapter II-IrrigationValue/Chapter-II/AquaCropOPSyData/CanolaCMIP126/OriPrcp/CanolaCMIP126_OriPrcp2032.csv',
    index=False)
